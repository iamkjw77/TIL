...
- `button`은 `font-size` 버그가 많았다. 부모의 속성과 같다면 `font-size: 1em`으로 재정의 해주자 
- 속성값
...
- `transition-property`, `transition-duration`은 필수속성
...
/* transition name | duration | transition name | duration | delay */
